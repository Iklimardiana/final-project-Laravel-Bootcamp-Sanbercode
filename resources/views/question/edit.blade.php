                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <div class="section-title-wrap mb-5">
                            <h4 class="section-title">Edit Data</h4>
                        </div>

                        <form action="/question/{{$question->id}}" method="POST" enctype="multipart/form-data" class="custom-form contact-form"  >
                        @csrf
                        @method('put')
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control"  name="question"
                                            placeholder="Describe message here">{{ $question->question }}</textarea>
                                    ...
                                    <div class="form-floating">
                                        <!-- <input type="text" name="company" id="name" class="form-control"
                                            ...
                                            @forelse ($category as $item)
                                                <option value="{{$item->id}}" @if ($item->id == $question->category_id) selected @endif>{{$item->name}}</option>    
                                            @empty
